...
func (m *MockUserCache) Get(ctx context.Context, id int64) (domain.UserDomain, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserCache) Set(ctx context.Context, doU domain.UserDomain) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Set", ctx, doU)
	ret0, _ := ret[0].(error)
	return ret0
}

// Set indicates an expected call of Set.
func (mr *MockUserCacheMockRecorder) Set(ctx, doU interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Set", reflect.TypeOf((*MockUserCache)(nil).Set), ctx, doU)
}

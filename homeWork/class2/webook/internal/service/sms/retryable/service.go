...
// SMSRetryableService 短信服务的重试
type SMSRetryableService struct {
	svc         sms.ServiceSmsInterface
	retryMaxCnt int
}

func (s *SMSRetryableService) Send(ctx context.Context, biz string, args []sms.NameArg, numbers ...string) error {
